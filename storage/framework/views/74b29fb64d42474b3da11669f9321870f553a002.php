...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        $('#othertrans').on('submit', function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('other.transection.store')); ?>",
                data: myformData,
                cache: false,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/payment/othertransection.blade.php ENDPATH**/ ?>