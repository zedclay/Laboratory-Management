...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <?php if(Auth::user()->user_type == 'Admin' || Auth::user()->user_type == 'Super Admin'): ?>
            <div class="row">
                <!-- Start col -->
                <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div>
                                                <p class="text-center dashboard-card-text">
                                                    <?php echo e(App\Models\Employees::get()->count()); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='px-3 py-3 justify-content-between'>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div>
                                                <p class="text-center dashboard-card-text"><?php echo e(App\Models\User::count()); ?>
                            ...
                            <div class='px-3 py-3 justify-content-between'>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div>
                                            <p class="text-center dashboard-card-text">
                                                <?php echo e(App\Models\Patients::get()->count()); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='px-3 py-3 justify-content-between'>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div>
                                            <p class="text-center dashboard-card-text">
                                                <?php echo e(App\Models\Referrals::get()->count()); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/dashboard.blade.php ENDPATH**/ ?>