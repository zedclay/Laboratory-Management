<?php $__env->startSection('title', 'Patients List'); ?>
    ...
    <script>
        $(function() {
            var table = $('.patitent_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('patients.list')); ?>",
                },
                columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value === true) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(URL::route('patients.destroy', '')); ?>/" + id,
                            data: {
                                "id": id,
                                "_token": token,
                            },
        ...
        $(document).on('change', '#status', function() {
            ...
            var url = "<?php echo e(URL::route('patients.status', '')); ?>/" + id;
            $.ajax({
                dataType: "json",
                url: url,
                method: 'get',
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/Patient/patient_list.blade.php ENDPATH**/ ?>