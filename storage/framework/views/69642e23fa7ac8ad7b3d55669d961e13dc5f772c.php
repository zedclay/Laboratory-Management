                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" class="status" id="status" data-toggle="toggle"
                                            ...
                                            data-offstyle="danger" data-id="<?php echo e($item->users->id); ?>"
                                            <?php echo e($item->users->status == 'Active' ? 'checked' : ''); ?>>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('employees.edit', $item->id)); ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?php echo e(route('employees.profile', $item->id)); ?>" class="btn btn-info btn-sm">
    ...
    <script>
        $(function() {
            ...
            $('#EmployeeForm').on('submit', function(e) {
                ...
                $.ajax({
    type: "POST",
    url: "<?php echo e(route('employees.add')); ?>",
    data: myformData,
    cache: false,
    processData: false,
    contentType: false,
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value === true) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(URL::route('employees.destroy', '')); ?>/" + id,
                            data: {
                                "id": id,
                                "_token": token,
                            },
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/Employees/employee.blade.php ENDPATH**/ ?>