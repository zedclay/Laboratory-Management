            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0 datatable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $labtest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="labtest<?php echo e($item->id); ?>">
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td class="text-wrap"><?php echo e($item->cat_name); ?></td>
                                    <td class="text-wrap"><?php echo e($item->department); ?></td>
                                    <td class="text-wrap"><?php echo e(number_format($item->price, 2)); ?></td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-warning btn-sm editbtn"
                                            data-id=<?php echo e($item->id); ?>><i class="fas fa-edit"></i></a>
    ...
    <script>
        $(function() {
            ...
            $('#LabTestForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('labtest.add')); ?>",
                    data: myformData,
                    cache: false,
                    processData: false,
                    contentType: false,
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value === true) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(URL::route('labtest.destroy', '')); ?>/" + id,
                            data: {
                                "id": id,
                                "_token": token,
                            },
            ...
            $('body').on('click', '.editbtn', function() {
                ...
                $.ajax({
                    dataType: "json",
                    url: "<?php echo e(URL::route('labtest.edit', '')); ?>/" + id,
                    method: 'get',
            ...
            $('#LabTesteditForm').submit(function(e) {
                ...
                $.ajax({
                    type: "PUT",
                    url: "<?php echo e(route('labtest.update')); ?>",
                    data: {
                        id: id,
                        cat_name1: cat_name1,
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/LabTest/labtest.blade.php ENDPATH**/ ?>