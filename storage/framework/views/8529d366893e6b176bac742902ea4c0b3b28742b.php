...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        $('#ConpanyForm').on('submit', function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('labdetails.add')); ?>",
                data: myformData,
                cache: false,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/maincompany/maincompany.blade.php ENDPATH**/ ?>