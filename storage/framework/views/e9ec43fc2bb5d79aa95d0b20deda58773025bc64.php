                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control" id="item-name" name="item_name">
                                    ...
                                    <?php $__currentLoopData = App\Models\Inventories::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(function() {
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('inventories')); ?>',
                columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                }, {
            ...
            $('#inventoryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('inventories.add')); ?>",
                    data: myformData,
                    cache: false,
                    processData: false,
                    contentType: false,
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value === true) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(URL::route('inventories.destroy', '')); ?>/" + id,
                            data: {
                                "id": id,
                                "_token": token,
                            },
            ...
            $('#updateinventoryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('inventories.update')); ?>",
                    data: myformData,
                    cache: false,
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/Inventories/inventories.blade.php ENDPATH**/ ?>