...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        $(function() {
            ...
            $(document).on('change', '#status', function() {
                ...
                var url = "<?php echo e(URL::route('user.status', '')); ?>/" + id;
                $.ajax({
                    dataType: "json",
                    url: url,
                    method: 'get',
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value === true) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(URL::route('user.delete', '')); ?>/" + id,
                            data: {
                                "id": id,
                                "_token": token,
                            },
            ...
            $('body').on('click', '.editbtn', function() {
                var id = $(this).data('id');
                var url = "<?php echo e(URL::route('user.edit', '')); ?>/" + id;
                $.ajax({
                    dataType: "json",
                    url: url,
                    method: 'get',
            ...
            $('#passchangeForm').submit(function(e) {
                ...
                $.ajax({
                    type: "PUT",
                    url: "<?php echo e(route('user.pass.update')); ?>",
                    data: {
                        "id": id,
                        "password": password,
                        "_token": _token,
    ...
    <script>
        $(document).on('change', '#employees', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.employees', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#patitents', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.patitents', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#testcategory', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.testcategory', '')); ?>/" + id,
                data: {
                    "id": id,
                    "catstatus": catstatus,
                },
        ...
        $(document).on('change', '#referral', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.referral', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#billing', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.billing', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#pathology', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.pathology', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#radiology', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.radiology', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#electrocardiography', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.electrocardiography', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#ultrasonography', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.ultrasonography', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#reportbooth', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.reportbooth', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#financial', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.financial', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#report_g', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.report_g', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
        ...
        $(document).on('change', '#inventory', function() {
            ...
            $.ajax({
                dataType: "json",
                url: "<?php echo e(URL::route('user.inventory', '')); ?>/" + id,
                method: 'get',
                data: {
                    "id": id,
                    "catstatus": catstatus,
...
<?php echo $__env->make('Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/Laboratory-Management/resources/views/user/user.blade.php ENDPATH**/ ?>